...
SOURCES = \
	__init__.py \
	Razmetka.py Razmetka_dockwidget.py
...
UI_FILES = Razmetka_dockwidget_base.ui
...
QGISDIR=C:\Users\Пользватель\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
